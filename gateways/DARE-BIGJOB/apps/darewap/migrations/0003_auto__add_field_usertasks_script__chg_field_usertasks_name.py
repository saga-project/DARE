...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserTasks.script'
        db.add_column('darewap_usertasks', 'script',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'UserTasks.name'
        db.alter_column('darewap_usertasks', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Deleting field 'UserTasks.script'
        db.delete_column('darewap_usertasks', 'script')


        # Changing field 'UserTasks.name'
        db.alter_column('darewap_usertasks', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
