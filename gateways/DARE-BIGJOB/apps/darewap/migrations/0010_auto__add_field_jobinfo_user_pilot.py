...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobInfo.user_pilot'
        db.add_column('darewap_jobinfo', 'user_pilot',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='userpilot', null=True, to=orm['darewap.UserPilots']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobInfo.user_pilot'
        db.delete_column('darewap_jobinfo', 'user_pilot_id')
    ...
    models = {
        ...
        'darewap.jobinfo': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {}),
            'user_pilot': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'userpilot'", 'null': 'True', 'to': "orm['darewap.UserPilots']"}),
