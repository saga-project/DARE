...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JobInfo.user_resource'
        db.delete_column('darewap_jobinfo', 'user_resource_id')

        # Adding field 'JobInfo.user_task'
        db.add_column('darewap_jobinfo', 'user_task',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='jobusertasks', null=True, to=orm['darewap.UserTasks']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'JobInfo.user_resource'
        db.add_column('darewap_jobinfo', 'user_resource',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user resource', null=True, to=orm['darewap.UserResource']),
                      keep_default=False)

        # Deleting field 'JobInfo.user_task'
        db.delete_column('darewap_jobinfo', 'user_task_id')
