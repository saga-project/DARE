...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserTasks.outputfiles'
        db.add_column('darewap_usertasks', 'outputfiles',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserTasks.outputfiles'
        db.delete_column('darewap_usertasks', 'outputfiles')
