...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserTasks.num_of_processes'
        db.add_column('darewap_usertasks', 'num_of_processes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'UserTasks.num_of_tasks'
        db.add_column('darewap_usertasks', 'num_of_tasks',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserTasks.num_of_processes'
        db.delete_column('darewap_usertasks', 'num_of_processes')

        # Deleting field 'UserTasks.num_of_tasks'
        db.delete_column('darewap_usertasks', 'num_of_tasks')
