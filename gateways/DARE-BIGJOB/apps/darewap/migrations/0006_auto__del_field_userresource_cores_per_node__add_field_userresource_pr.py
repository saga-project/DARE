...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserResource.cores_per_node'
        db.delete_column('darewap_userresource', 'cores_per_node')

        # Adding field 'UserResource.processes_per_node'
        db.add_column('darewap_userresource', 'processes_per_node',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserResource.cores_per_node'
        db.add_column('darewap_userresource', 'cores_per_node',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'UserResource.processes_per_node'
        db.delete_column('darewap_userresource', 'processes_per_node')
