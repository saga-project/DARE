...
<div class="body_background">
	...
	%endif
      ...
      <li><a href='')}">ABOUT DARE-HTHP</a>
         <ul>

            <li ><a title="Pipeline"  href="${url('/hthpmd/resources')}" >Resources</a></li>
...
% if c.userid!="3231312":
          <li ><a title="Pipeline"  href="${url('/hthpmd/namd_form')}" >NAMD</a></li>

%endif
          <li><a href="${url('/hthpmd/job_table_view')}">Job Table View</a></li>

        </ul>
      </li>
      <li><a href="${url('/hthpmd/software')}">SOFTWARE</a></li>
      <li><a href="${url('/hthpmd/contact')}">CONTACT</a></li>
				</ul>
			</div>
		</div><!-- inner -->
	</div><!-- header -->
