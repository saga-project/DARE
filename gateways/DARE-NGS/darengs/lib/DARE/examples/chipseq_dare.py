...
##########          wu_0        ######################################################
    ...
    dare_config.set(section_name, "arguments",  os.path.join(DARE_HOME, "examples/chipseq/user_input", control_input) +" "+ os.path.join(working_directory, control_input_name +"_control.fastq" ) )
...
##########          wu_0        ######################################################
    ...
    dare_config.set(section_name, "number_of_processes","2")
    dare_config.set(section_name, "spmd_variation", "single")
    dare_config.set(section_name, "arguments",  os.path.join(DARE_HOME, "examples/chipseq/user_input" ,treat_input) +" "+ os.path.join(working_directory, treat_input_name+ "_treat.fastq") )
    dare_config.set(section_name, "environment", "")
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
    dare_config.set(section_name, "error", os.path.join(working_directory, "stderr-"+ str(dare_uuid) +"-"+str(wus_count)+".txt" ))
    ...
    control_input_name = control_input_name+"_control"
    treat_input_name = treat_input_name+"_treat"
###################################################################################################
##########          step =1 (compute)         ######################################################
###################################################################################################
    ...
    if (job_conf["reference_genome"] == "ws200"):
       if job_conf["mapping"]=="bowtie":
           ref_fa = os.path.join(step_resource_conf["ngsdata"], "GENOME_DATABASE/NEMATODE/ws200/bowtie/c_elegans_ws200")
       else:
...
##########          wu_1        ######################################################
    ...
    dare_config.set(section_name, "arguments", step_resource_conf[args] +" "\
          + ref_fa + " "\
          + os.path.join(working_directory, control_input_name + ".fastq")+ " > "\
          + os.path.join(working_directory, control_input_name + ".sai") )
...
##########          wu_2        ######################################################
    ...
    dare_config.set(section_name, "arguments", step_resource_conf[args] +" "\
          + ref_fa + " "\
          + os.path.join(working_directory, treat_input_name +".fastq")+ " > "\
          + os.path.join(working_directory, treat_input_name +".sai") )
    dare_config.set(section_name, "environment", step_resource_conf["environment"])
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
    dare_config.set(section_name, "error", os.path.join(working_directory, "stderr-"+ str(dare_uuid) +"-"+str(wus_count)+".txt" ))
...
##########          wu_3        ######################################################
    ...
    dare_config.set(section_name, "arguments", step_resource_conf["arguments"] +" "\
        ...
        + os.path.join(working_directory, control_input_name +".sai")+ " " \
        + os.path.join(working_directory, control_input_name + ".fastq") + " > "\
        + os.path.join(working_directory, control_input_name +".sam")
        )
    dare_config.set(section_name, "environment", step_resource_conf["environment"])
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
...
##########          wu_4        ######################################################
    ...
    dare_config.set(section_name, "arguments", step_resource_conf["arguments"] +" "\
        ...
        + os.path.join(working_directory, treat_input_name +".sai")+ " "\
        + os.path.join(working_directory, treat_input_name + ".fastq") +  " > "\
        + os.path.join(working_directory, treat_input_name +".sam")
        )
    dare_config.set(section_name, "environment", step_resource_conf["environment"])
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
...
##########          wu_5       ######################################################
    ...
    dare_config.set(section_name, "arguments", step_resource_conf["arguments"] +" "\
        + os.path.join(working_directory, control_input_name +".sam")
        +  " > " + os.path.join(working_directory, control_input_name +".bam")
        )
    dare_config.set(section_name, "environment", step_resource_conf["environment"])
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
...
##########          wu_6       ######################################################
    ...
    dare_config.set(section_name, "arguments", step_resource_conf["arguments"] +" "\
        + os.path.join(working_directory, treat_input_name +".sam")
        +  " > " + os.path.join(working_directory, treat_input_name +".bam")
        )
    dare_config.set(section_name, "environment", step_resource_conf["environment"])
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
...
##########          wu_7      ######################################################
    ...
    dare_config.set(section_name, "arguments", step_resource_conf["arguments"] +" "\
        + os.path.join(working_directory, control_input_name +".bam")
        + " " + os.path.join(working_directory, control_input_name +"-sorted")
        )
    dare_config.set(section_name, "environment", step_resource_conf["environment"])
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
...
##########          wu_8      ######################################################
    ...
    dare_config.set(section_name, "arguments", step_resource_conf["arguments"] +" "\
        + os.path.join(working_directory, treat_input_name +".bam")
        + " " + os.path.join(working_directory, treat_input_name +"-sorted")
        )
    dare_config.set(section_name, "environment", step_resource_conf["environment"])
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
...
##########          wu_9     ######################################################
    ...
    dare_config.set(section_name, "spmd_variation", step_conf["spmd_variation"])
    dare_config.set(section_name, "arguments", step_resource_conf["arguments"] +" "\
        + os.path.join(working_directory, control_input_name +".-sorted.bam")
        )
    dare_config.set(section_name, "environment", step_resource_conf["environment"])
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
...
##########          wu_10     ######################################################
    ...
    dare_config.set(section_name, "spmd_variation", step_conf["spmd_variation"])
    dare_config.set(section_name, "arguments", step_resource_conf["arguments"] +" "\
        + os.path.join(working_directory, treat_input_name +"-sorted.bam")
        )
    dare_config.set(section_name, "environment", step_resource_conf["environment"])
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
...
##########          wu_11     ######################################################
    ...
    dare_config.set(section_name, "number_of_processes", step_conf["number_of_processes"])
    dare_config.set(section_name, "spmd_variation", step_conf["spmd_variation"])
    dare_config.set(section_name, "arguments",  step_resource_conf[args] + " -t "\
        + os.path.join(working_directory, treat_input_name +"-sorted.bam")   +" -c "\
        + os.path.join(working_directory, control_input_name +"-sorted.bam")
        )
    dare_config.set(section_name, "environment", step_resource_conf["environment"])
    dare_config.set(section_name, "working_directory", working_directory)
...
##########          wu_12     ######################################################
    ...
    dare_config.set(section_name, "spmd_variation", step_conf["spmd_variation"])
    dare_config.set(section_name, "arguments",  step_resource_conf["arguments"]+ " " \
    + os.path.join(working_directory, "test_peaks.bed")\
    +" "+os.path.join(working_directory, "out_peaks.bed")
        )
    dare_config.set(section_name, "environment", "")
    dare_config.set(section_name, "working_directory", working_directory)
    dare_config.set(section_name, "output", os.path.join(working_directory, "stdout-"+ str(dare_uuid) +"-"+str(wus_count)+".txt"))
