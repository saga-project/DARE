...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserResource.username'
        db.delete_column('darewap_userresource', 'username')

        # Deleting field 'UserResource.hostname'
        db.delete_column('darewap_userresource', 'hostname')

        # Adding field 'UserResource.service_url'
        db.add_column('darewap_userresource', 'service_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserResource.username'
        db.add_column('darewap_userresource', 'username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'UserResource.hostname'
        db.add_column('darewap_userresource', 'hostname',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserResource.service_url'
        db.delete_column('darewap_userresource', 'service_url')
