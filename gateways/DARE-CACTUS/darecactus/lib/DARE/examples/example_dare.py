...
###################################################################################################
    ...
    working_directory = "/home/smaddi2/agent/"#os.path.join(DARE_HOME, "darefiles", str(jobid)) 
...
###################################################################################################    
    ...
    for i in range (0, num_step_wus[step]):   
        ...
        dare_config.set(section_name, "dest_url", "smaddi2@cyder.cct.lsu.edu:/home/smaddi2/agent/"\
        + str(i)+ ".txt") 
