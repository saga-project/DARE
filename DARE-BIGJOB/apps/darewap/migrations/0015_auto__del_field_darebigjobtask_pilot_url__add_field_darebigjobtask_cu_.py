...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DareBigJobTask.pilot_url'
        db.delete_column(u'darewap_darebigjobtask', 'pilot_url')

        # Adding field 'DareBigJobTask.cu_url'
        db.add_column(u'darewap_darebigjobtask', 'cu_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DareBigJobTask.pilot_url'
        db.add_column(u'darewap_darebigjobtask', 'pilot_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Deleting field 'DareBigJobTask.cu_url'
        db.delete_column(u'darewap_darebigjobtask', 'cu_url')
    ...
    models = {
        ...
        u'darewap.darebigjobtask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'cu_url': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'dare_bigjob': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['darewap.DareBigJob']"}),
