...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'darewap_defaultdarebigjobpilot', (
        ...
        db.send_create_signal(u'darewap', ['DefaultDareBigJobPilot'])

        # Adding model 'DareBigJob'
        db.create_table(u'darewap_darebigjob', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ...
        db.send_create_signal(u'darewap', ['DareBigJob'])

        # Adding model 'DareBigJobTask'
        db.create_table(u'darewap_darebigjobtask', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ...
        db.send_create_signal(u'darewap', ['DareBigJobTask'])

        # Adding model 'DareBigJobPilot'
        db.create_table(u'darewap_darebigjobpilot', (
            (u'defaultdarebigjobpilot_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['darewap.DefaultDareBigJobPilot'], unique=True, primary_key=True)),
            ('dare_bigjob', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['darewap.DareBigJob'])),
        ))
        db.send_create_signal(u'darewap', ['DareBigJobPilot'])


    def backwards(self, orm):
        # Deleting model 'DefaultDareBigJobPilot'
        db.delete_table(u'darewap_defaultdarebigjobpilot')

        # Deleting model 'DareBigJob'
        db.delete_table(u'darewap_darebigjob')

        # Deleting model 'DareBigJobTask'
        db.delete_table(u'darewap_darebigjobtask')

        # Deleting model 'DareBigJobPilot'
        db.delete_table(u'darewap_darebigjobpilot')
