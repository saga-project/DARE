...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserPilots'
        db.create_table('darewap_userpilots', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_pilots', null=True, to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('detail', self.gf('picklefield.fields.PickledObjectField')(null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('darewap', ['UserPilots'])


        # Changing field 'UserResource.name'
        db.alter_column('darewap_userresource', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Deleting model 'UserPilots'
        db.delete_table('darewap_userpilots')


        # Changing field 'UserResource.name'
        db.alter_column('darewap_userresource', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
