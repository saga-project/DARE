...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('darewap_jobinfo', (
            ...
            ('user_resource', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user resource', null=True, to=orm['darewap.UserResource'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        ...
        # Adding model 'UserTasks'
        db.create_table('darewap_usertasks', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_tasks', null=True, to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('executable', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ...
            ('env', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('spmd_variation', self.gf('django.db.models.fields.CharField')(default='single', max_length=30)),
            ('num_of_cores', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
        ))
        db.send_create_signal('darewap', ['UserTasks'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UserTasks'
        db.delete_table('darewap_usertasks')
    ...
    models = {
        ...
        'darewap.usertasks': {
            ...
            'executable': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'spmd_variation': ('django.db.models.fields.CharField', [], {'default': "'single'", 'max_length': '30'}),
