...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DareBigJobTask.dare_bigjob_pilot'
        db.add_column(u'darewap_darebigjobtask', 'dare_bigjob_pilot',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['darewap.DareBigJobPilot'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DareBigJobTask.inputfiles'
        db.add_column(u'darewap_darebigjobtask', 'inputfiles',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'DareBigJobTask.outputfiles'
        db.add_column(u'darewap_darebigjobtask', 'outputfiles',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DareBigJobTask.dare_bigjob_pilot'
        db.delete_column(u'darewap_darebigjobtask', 'dare_bigjob_pilot_id')

        # Deleting field 'DareBigJobTask.inputfiles'
        db.delete_column(u'darewap_darebigjobtask', 'inputfiles')

        # Deleting field 'DareBigJobTask.outputfiles'
        db.delete_column(u'darewap_darebigjobtask', 'outputfiles')
    ...
    models = {
        ...
        u'darewap.darebigjobpilot': {
            'Meta': {'object_name': 'DareBigJobPilot', '_ormbases': [u'darewap.DefaultDareBigJobPilot']},
            'dare_bigjob': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['darewap.DareBigJob']"}),
            u'defaultdarebigjobpilot_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['darewap.DefaultDareBigJobPilot']", 'unique': 'True', 'primary_key': 'True'})
        },
