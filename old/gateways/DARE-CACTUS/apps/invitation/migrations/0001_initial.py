...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invitation_invitationkey', (
            ...
            ('registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='invitations_used', null=True, to=orm['auth.User'])),
        ))
        ...
        # Adding model 'RequestInvite'
        db.create_table('invitation_requestinvite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('email_sent', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('is_approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('invitation', ['RequestInvite'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'RequestInvite'
        db.delete_table('invitation_requestinvite')
    ...
    models = {
        ...
        'invitation.requestinvite': {
            'Meta': {'object_name': 'RequestInvite'},
            'email': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'email_sent': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
