...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RequestInvite.email'
        db.alter_column('invitation_requestinvite', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RequestInvite.email'
        db.alter_column('invitation_requestinvite', 'email', self.gf('django.db.models.fields.CharField')(max_length=30))
