...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Job.dareprocess_id'
        db.delete_column('darewap_job', 'dareprocess_id')

        # Adding field 'Job.name'
        db.add_column('darewap_job', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Job.dareprocess_id'
        db.add_column('darewap_job', 'dareprocess_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Deleting field 'Job.name'
        db.delete_column('darewap_job', 'name')
