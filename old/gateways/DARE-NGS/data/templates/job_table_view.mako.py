...
_magic_number = 6
_modified_time = 1322434668.911431
_template_filename='/Users/Sharath/projects/projects/DARE-NGS/darengs/templates/job_table_view.mako'
                ...
                for i in job.jobinfo:
                    ...
                    if (i.key == "appname"):
                        ...
                        if (i.value =="chipseq"):
                            # SOURCE LINE 80
                            __M_writer(u'                 \t\t    ')
                            __M_writer(escape(h.link_to("Download output Bed file", url('/ngs/output_download', id=job.id, t=0))))
                            __M_writer(u'\n                 \t\t    ')
                            # SOURCE LINE 81
                            __M_writer(escape(h.link_to("Download output Excel file", url('/ngs/output_download', id=job.id, t=2))))
                            __M_writer(u'\n\n                 \t\t     <br/>\n')
                            pass
                        pass
                    pass
                ...
                for i in job.jobinfo:
                    ...
                    if (i.key == "Reference_GENOME"):
                        ...
                        if (i.value =="ws200"):
                            # SOURCE LINE 92
                            __M_writer(u'                 \t\t    ')
                            __M_writer(escape(h.link_to("Using Genome Browser",url("http://www.wormbase.org/db/gb2/gbrowse/c_elegans/"))))
                            __M_writer(u'\n                 \t\t     <br/>\n')
                            pass
                        pass
                    pass
